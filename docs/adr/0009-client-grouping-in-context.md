...
The concrete trigger: PLN/ICON+'s proposal, kick-off notes, production-namespace ADR, and
...
material the instant a second client arrives, and with no place for a second PLN/ICON+
